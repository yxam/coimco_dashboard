...
import { ChartRankPPriceService } from './components/chartistJsProduct/product/RankPPrice/chartRankPPrice.service';
...
@NgModule({
  ...
  providers: [
    ...
    ChartRankPPriceService,
    ChartProductPriceTimeService,
