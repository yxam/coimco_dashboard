    ...
    this.conf = {
      ...
      colors: {
        ...
        dashboard: {
          ...
          blueWhite: this.dashboardColors.blueWhite,
          blueGreen: this.dashboardColors.blueGreen,
          greenBlue: this.dashboardColors.greenBlue,
          greenRare: this.dashboardColors.greenRare,
